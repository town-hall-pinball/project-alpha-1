...
class ScoreDisplay(Mode):
	...
	def __init__(self, game, priority, fonts, left_players_justify="right"):
		super(ScoreDisplay, self).__init__(game, priority)
		self.layer = ScoreLayer(128, 32, self)
		self.font_common = fonts["plain"]
		self.font_18x12 = fonts["Font18x12"]
		self.font_18x11 = fonts["Font18x11"]
		self.font_18x10 = fonts["Font18x10"]
		self.font_14x10 = fonts["Font14x10"]
		self.font_14x9 = fonts["Font14x9"]
		self.font_14x8 = fonts["Font14x8"]
		self.font_09x5 = fonts["Font09x5"]
		self.font_09x6 = fonts["Font09x6"]
		self.font_09x7 = fonts["Font09x7"]
